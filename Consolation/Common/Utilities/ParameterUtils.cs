...
namespace Consolation.Common.Utilities
{
    ...
    public static class ParameterUtils
    {
        ...
        /// <param name="parameter">The parameter you want to get the value of.</param>
        /// <returns><c>true</c> if the specified parameter is found, else <c>false</c>.</returns>
        public static bool ParameterExists(this string[] args, string parameter) => args.TryGetParameterValue(parameter, out _);

        /// <summary>
        /// Finds the <c>index</c> of the specified parameter by converting <paramref name="args"/> to a <see cref="List{T}"/> with <see cref="Enumerable.ToList{T}"/> and then returning <see cref="List{T}.IndexOf(T)"/>
        /// </summary>
        /// <param name="args">The array of parameter arguments you want to check.</param>
        /// <param name="parameter">The parameter you want to get the value of.</param>
