...
namespace Patcher.Tests
{
    public static class PatchNodeSortTest
    {
        ...
        private abstract class DummyPatch : IPatch
        {
            public MethodInfo ModifiedMethod => null!;

            public MethodInfo ModifyingMethod => null!;
            
            public object PatchMethod { get; }
            
            public virtual Type? Dependency { get; }
